...
export const ProfileBadgesScreen: React.FC = () => {
    ...
    <Screen>
      <header className="sticky top-0 z-40 bg-white border-b border-gray-200 safe-area-top">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <h1 className="text-sm font-semibold text-slate-900">My Badges</h1>
          <div className="w-8" />
        </div>
      </header>
      <div className="flex min-h-screen flex-col bg-slate-50 px-4 py-6">
        <p className="text-xs text-slate-500">
          TODO: Implement badge collection display (No Waste Week, Under $3 Master, etc.)
        </p>
      </div>
    </Screen>
  );
